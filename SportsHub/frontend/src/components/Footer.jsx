    ...
    <footer className={isDarkMode ? 'bg-black/50 text-white' : 'bg-gray-900 text-white'}>
      ...
      <div className="max-w-7xl mx-auto mt-5 px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
          ...
          {/* Brand Section - Full width on mobile, spans 2 cols on medium screens */}
          <div className="md:col-span-2 lg:col-span-1">
            ...
            <div className="space-y-2 text-xs lg:text-sm">
              <div className="flex items-center space-x-2 text-gray-400">
                ...
                <span className="truncate">customersupport@sportshub.com</span>
              </div>
              <div className="flex items-center space-x-2 text-gray-400">
          ...
          <div className="md:col-span-2 lg:col-span-1">
            ...
            <div className="flex flex-col space-y-2">
              <input
                ...
                className={`px-3 py-2 text-sm rounded-lg transition-all duration-300 ${isDarkMode
              ...
              />
              <button className={`px-4 py-2 text-sm rounded-lg font-medium transition-all duration-300 ${isDarkMode
