...
import { 
  Mail, Lock, Eye, EyeOff, User, Phone, Trophy, 
...
const Login: React.FC<LoginProps> = ({ isDarkMode, setIsLoggedIn }) => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Build your comprehensive sports profile and showcase skills'
    },
    {
      icon: Users,
          ...
          <div className="relative z-10 flex flex-col justify-center p-12">
            ...
            >
              ...
              <p className={`text-xl mb-12 ${
                ...
                Join thousands of athletes who are already using SportsHub to enhance their performance and connect with the global sports community.
              </p>
                ...
                {!isLogin && (
                  <>
                    ...
                    <div>
                      ...
                      >
                        <option value="player" className={isDarkMode ? 'bg-gray-800' : 'bg-white'}>Player</option>
                        <option value="faculty" className={isDarkMode ? 'bg-gray-800' : 'bg-white'}>Club Faculty</option>
                      </select>
                    </div>
                  </>
                )}
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <p className={`text-sm ${
                        ...
                        <Link to="/terms" className={isDarkMode ? 'text-orange-400' : 'text-blue-600'}>
                          Terms of Service
                        </Link>{' '}
                        and{' '}
                        <Link to="/privacy" className={isDarkMode ? 'text-orange-400' : 'text-blue-600'}>
                          Privacy Policy
                        </Link>
                      </p>
                    </div>
