  ...
  useEffect(() => {
    const fetch_data = async () => {
      try {
        ...
        const res = await axios.get(`${import.meta.env.BACKEND_URL}/users/profile`, {
    ...
    const fetch_training_data = async (user_id) => {
      try {
        ...
        const res = await axios.get(
          `${import.meta.env.BACKEND_URL}/api/custom-training-plans/user/${user_id}`
        );
        if (res.status == 200) {
          console.log(res.data);
            ...
            <div className="flex flex-col sm:flex-row sm:items-end gap-3 sm:gap-0 items-center space-y-4 md:space-y-0 md:space-x-6">
              ...
              <div className="relative">
                ...
                <form
                  ...
                  action={`${import.meta.env.BACKEND_URL}/users/profile/photo`}
                  method="PUT"
                >
