    ...
    return (
        <div className={`pt-28 px-6 md:px-12 lg:px-24 min-h-screen ${isDarkMode ? 'text-white' : 'text-black'}`}>
            ...
            <div className={`${sectionBg} p-6 rounded-xl mb-8`}>
                <h3 className={`text-xl font-semibold mb-4 ${accentColor}`}>Contact Information</h3>
                <div className="grid md:grid-cols-2 gap-4">
                    <div className="space-y-3">
                        {club.officialEmail && (
                            <div className="flex items-center space-x-2 text-sm">
                                <Mail className="w-4 h-4 text-gray-400" />
                                <a href={`mailto:${club.officialEmail}`} className="hover:underline">
                                    {club.officialEmail}
                                </a>
                            </div>
                        )}
                        {club.contactNumber && (
                            <div className="flex items-center space-x-2 text-sm">
                                ...
                                <a href={`tel:${club.contactNumber}`} className="hover:underline">
                                    {club.contactNumber}
                                </a>
                            </div>
                        )}
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-8">
                <div className={`${cardBg} p-4 rounded-xl text-center`}>
                    ...
                    <p className="text-xl font-bold">{club.performance?.totalMatches || 0}</p>
            ...
            {club.sports?.length > 0 && (
                <div className="mb-10">
                    <h2 className={`text-2xl font-semibold mb-4 ${accentColor}`}>Sports</h2>
                    <div className="flex flex-wrap gap-3">
                        {club.sports.map((sport, index) => (
                            <span key={index} className={`${cardBg} px-4 py-2 rounded-full text-sm`}>
                                {sport}
                            </span>
                        ))}
                    </div>
